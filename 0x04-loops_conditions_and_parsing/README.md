...
- [Tasks](#tasks)
	- [0. Create a SSH RSA key pair](#0)
	- [1. For Best School loop](#1)
	- [2. While Best School loop](#2)
	- [3. Until Best School loop](#3)
	- [4. If 9, say Hi!](#4)
	- [5. 4 bad luck, 8 is your chance](#5)
	- [6. Superstitious numbers](#6)
	- [7. Clock](#7)
	- [8. For ls](#8)
	- [9. To file, or not to file](#9)
	- [10. FizzBuzz](#10)
	- [11. Read and cut](#11)
	- [12. Tell the story of passwd](#12)
	- [13. Let's parse Apache logs](#13)
	- [14. Dig the data](#14)
---
## Author Details
